...
def ExtraWhite(a):
    try: a = fold(a)# "Clean" to common ascii
    except: None
    try: a = safe_load(a)# load as yaml cleaning linebreaks with some tolerance
    except: None
    try: a = str(dumps(a))# Trnasform in "orthodoxe" string object
    except: None
    return a
